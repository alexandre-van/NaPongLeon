...
function createBorders() {
    const borderGeometry = new THREE.BoxGeometry(arenaLength - wallWidth, wallWidth, wallHeight);
    ...
    borderLeft.position.set(-arenaLength / 2, 0, 1);
    borderRight.position.set(arenaLength / 2, 0, 1);
